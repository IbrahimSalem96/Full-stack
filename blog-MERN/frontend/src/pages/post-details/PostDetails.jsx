...
import { fetchSinglePost, toggleLikePost, updatePostImage, deletePost } from "../../apiCalls/postApiCall";
...
const PostDetails = () => {
  ...
  const updateImageSubmitHandler = (e) => {
    ...
    dispatch(updatePostImage(post?._id, fromData))
  }
  ...
  return (
    <div className="post-details">
      ...
      <div className="post-details-user-info">
        <img src={post?.user.profilePhoto?.url} alt="photo" className="post-details-user-image" />
      ...
      {user ?
        <AddComment postId={post?._id} /> : <p className="post-details-info-write">to write a comment you should login first</p>
      }
